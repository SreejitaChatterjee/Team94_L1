...
extern "C" void litex_sim_init(void **out)
{
    ...
    litex_sim_init_tracer(sim, 0, -1, 0, -1);
    ...
    eth0[0].signal = &sim->eth0_source_valid;
    eth0[1].signal = &sim->eth0_source_ready;
    eth0[2].signal = &sim->eth0_source_data;
    eth0[3].signal = &sim->eth0_sink_valid;
    eth0[4].signal = &sim->eth0_sink_ready;
    eth0[5].signal = &sim->eth0_sink_data;
    litex_sim_register_pads(eth0, (char*)"eth", 0);
